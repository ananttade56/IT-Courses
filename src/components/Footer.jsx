        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-12">
          ...
          <div className="lg:col-span-1 space-y-6">
            <a href="/">
              ...
              <img src="/asset/csrLogo.png" alt="TechEdu Logo" className="h-10 bg-white p-1 rounded w-auto object-contain" />
            </a>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-400">
              ...
              <li><a href="#" className="hover:text-white transition-colors">AWS Cloud</a></li>
