...
const faqs = [
  ...
  { question: 'What is the mode of training?', answer: 'We offer both online and offline (classroom) training modes.' },
            ...
            <div className="flex flex-col md:flex-row gap-8">
              ...
              <div className="flex-1 space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <p className="text-sm text-gray-600">Mon - Sat: 9:00 AM - 7:00 PM<br/>Sunday: Closed</p>
                  </div>
                </div>
              </div>
              ...
              <div className="flex-1">
                <form className="space-y-4">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <input type="text" placeholder="Your Name" className="w-full px-4 py-2 bg-gray-50 border border-gray-200 rounded-md focus:outline-none focus:ring-1 focus:ring-blue-500 text-sm" />
                    <input type="email" placeholder="Your Email" className="w-full px-4 py-2 bg-gray-50 border border-gray-200 rounded-md focus:outline-none focus:ring-1 focus:ring-blue-500 text-sm" />
                  </div>
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <input type="text" placeholder="Your Phone" className="w-full px-4 py-2 bg-gray-50 border border-gray-200 rounded-md focus:outline-none focus:ring-1 focus:ring-blue-500 text-sm" />
                    <select className="w-full px-4 py-2 bg-gray-50 border border-gray-200 rounded-md focus:outline-none focus:ring-1 focus:ring-blue-500 text-sm text-gray-500">
                  ...
                  <textarea placeholder="Your Message" rows="3" className="w-full px-4 py-2 bg-gray-50 border border-gray-200 rounded-md focus:outline-none focus:ring-1 focus:ring-blue-500 text-sm"></textarea>
